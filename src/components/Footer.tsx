...
const Footer = () => {
  ...
  return (
    <footer className="bg-wolf-brown text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-white/80 mb-6 max-w-md">
              Wolf Agro Services - {t('heroTitle')}
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/#hero" className="text-white/80 hover:text-white transition-colors">
                  {t('home')}
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center text-white/80">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 mr-2 text-wolf-green">
        ...
        <div className="border-t border-white/20 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4">
            ...
            <a href="https://wa.me/22720170401" className="text-white/60 hover:text-white transition-colors">
