          ...
          <div className="flex flex-col justify-between">
            ...
            <div className="mt-8 lg:mt-0">
              ...
              <div className="flex space-x-4">
                ...
                <a href="https://wa.me/+221763082932" className="w-10 h-10 bg-wolf-green/10 rounded-full flex items-center justify-center hover:bg-wolf-green hover:text-white transition-colors">
